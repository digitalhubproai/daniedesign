// 404 page. Next renders this automatically for any unmatched route, and it is
// also the target of notFound() calls in the dynamic /work/[slug] and /blog/[slug]
// pages. Fully static — no data source.

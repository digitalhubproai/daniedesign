// "/work" portfolio index. Static server component providing hero copy and
// metadata; the filterable grid itself is ProjectGrid, a client component that
// reads the project list from the static @/data/projects file (no API fetch).

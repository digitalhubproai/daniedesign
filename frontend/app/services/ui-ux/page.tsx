// "/services/ui-ux" service detail page. Fully static server component — all
// copy (hero, split sections, capabilities list, outro stats/process/CTA) is
// hardcoded in the JSX below; no data/ imports and no API fetch.

...
/**
 * Homepage blog teaser: renders the three latest studio posts as
 * tilt-hover cards linking into the full blog.
 */
export default function BlogPreview() {
  // Only the first three posts are featured on the homepage
